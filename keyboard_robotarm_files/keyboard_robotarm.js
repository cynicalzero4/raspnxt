 ...
 */
KEYBOARD_ROBOTARM.Robotarm = function(options) {
  var that = this;
  options = options || {};
  var ros = options.ros;
  ...
  // sets up a key listener on the page used for keyboard robotarm
  var handleKey = function(keyCode, keyDown) {
    ...
    switch (keyCode) {
      case 65:
        x = 1 * speed;
        console.log("orario_1")
        break;
      case 68:
        x = -1 * speed;
        console.log("antiorario_1")
        break;
      case 87:
        y = 1 * speed;
        console.log("su_2")
...
KEYBOARD_ROBOTARM.Robotarm.prototype.__proto__ = EventEmitter2.prototype;